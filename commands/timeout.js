...
const sanctionsFilePath = path.join(__dirname, '../database/sanctions.json');
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            let sanctions = {};
            if (fs.existsSync(sanctionsFilePath)) {
                const fileContent = fs.readFileSync(sanctionsFilePath, 'utf8');
                if (fileContent) {
            ...
            fs.writeFileSync(sanctionsFilePath, JSON.stringify(sanctions, null, 2));
