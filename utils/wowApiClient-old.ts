// Configuration pour les APIs externes WoW - VERSION SIMPLIFIÉE RAIDER.IO SEULEMENT
// Raider.IO est gratuit, fiable et a une excellente couverture des serveurs français

// Fonction intelligente pour normaliser un nom de royaume pour Raider.IO
function normalizeRealmName(realmName: string): string[] {
    ...
    // 4. Mappings directs pour les serveurs français populaires
...
export const WOW_API_CONFIG = {
    // Raider.IO - API gratuite et fiable, excellente pour les guildes françaises
    RAIDER_IO: {
...
// Interface pour les données de guilde (Raider.IO seulement)
